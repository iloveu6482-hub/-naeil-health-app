...
export const sampleNotificationSettings: NotificationSetting[] = [
  { id: "noti-meal-lunch", type: "meal", title: "점심 식사 기록", description: "점심시간에 메뉴와 식사 상태 기록을 알려드려요.", enabled: true, time: "11:50" },
  { id: "noti-meal-dinner", type: "meal", title: "저녁 식사 기록", description: "저녁 식사 후 메뉴와 채소 포함 여부를 기록해보세요.", enabled: true, time: "18:00" },
...
export const sampleMotivationMessages: MotivationMessage[] = [
  { id: "msg-lunch", type: "meal", title: "점심시간이에요", message: "오늘 먹은 메뉴와 채소 포함 여부를 가볍게 기록해보세요.", actionLabel: "식사 기록하기", actionHref: "/meals/new" },

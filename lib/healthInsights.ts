...
export function createCheckupInsights(checkup: HealthCheckup, log?: DailyLog): CheckupInsight[] {
  ...
  result.push(checkup.fastingGlucose < 100
    ...
    : { id: "sugar", category: "bloodSugar", title: "혈당 관리", status: checkup.fastingGlucose >= 126 ? "needsCare" : "caution", summary: "식사 구성과 식후 활동을 점검해보면 좋습니다.", recommendedMissions: ["식후 10분 걷기", "단 음료 줄이기", "식단 사진 기록"] });
  ...
  if (checkup.bmi >= 25 || checkup.waist >= 85) result.push({ id: "weight", category: "weight", title: "체중·허리둘레 관리", status: "caution", summary: "무리하지 않는 식사 기록과 꾸준한 걷기가 도움이 될 수 있습니다.", recommendedMissions: ["식단 사진 1회", "7,000보 걷기", "야식 줄이기"] });

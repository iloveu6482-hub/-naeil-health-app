...
function isSeasonalThemeItem(item: AvatarItem) {
  return ["theme-summer", "theme-spring", "theme-autumn", "theme-winter"].includes(item.id);
}

function getUnavailableLabel(item: AvatarItem) {
  return isSeasonalThemeItem(item) ? "시즌한정" : "준비중";
}
